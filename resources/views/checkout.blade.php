...
>>>>>>> 23117737aaa5d1514970ed54c2a70801606a95e7
    ...
    document.getElementById('checkoutForm').addEventListener('submit', function(e) {
        ...
        if(parseInt(costInput) === 0 || costInput === "") {
            e.preventDefault();
            Swal.fire({ icon: 'warning', title: 'Pilih Layanan Pengiriman', text: 'Silakan pilih salah satu layanan pengiriman JNE terlebih dahulu!', confirmButtonColor: '#f59e0b' });
        }
    });
        ...
        if (provinceId) {
            ...
            fetch('/get-cities/' + provinceId) // Sesuaikan URL ini dengan URL Route kamu
                ...
                .catch(error => {
                    ...
                    Swal.fire({ icon: 'error', title: 'Gagal!', text: 'Gagal memuat data kota. Silakan coba lagi.', toast: true, position: 'top-end', showConfirmButton: false, timer: 3000 });
                });
        }
    });
</script>
